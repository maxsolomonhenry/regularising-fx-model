...
def CAFxR(win_length, filters, kernel_size_1, learning_rate):
    ...
    Y_ = Dense(filters, activation = 'relu', name = 'dense_saaf_in',
              kernel_regularizer=regularizers.l2(0.01))(Y_)
    Y_ = Dense(filters//2, activation = 'relu', name = 'dense_saaf_h1',
              kernel_regularizer=regularizers.l2(0.01))(Y_)
    Y_ = Dense(filters//2, activation = 'relu', name = 'dense_saaf_h2',
              kernel_regularizer=regularizers.l2(0.01))(Y_)
    Y_ = Dense(filters//2, activation = 'relu', name = 'dense_saaf_h3',
              kernel_regularizer=regularizers.l2(0.01))(Y_)
    Y_ = Dense(filters, activation = 'linear', name = 'dense_saaf_out',
              kernel_regularizer=regularizers.l2(0.01))(Y_)
    
    Y_ = SAAF(break_points=25, break_range=0.2, magnitude=100, order=2, tied_feamap=True,
            kernel_initializer = 'random_normal', name = 'saaf_out',
             kernel_regularizer=regularizers.l2(0.01))(Y_)
